...
function fnMapper(data){
  elList.innerHTML = ''
    ...
    <p>${item}</p>
    <button class="btn m-1 btn-danger" onclick="fnDel(${index})"> O'chirish</button>
    <button onclick="fnUpdate(${index})" class="btn btn-info m-1 "  data-bs-toggle="modal" data-bs-target="#exampleModal">Tahrirlash</button>
  </div>`
